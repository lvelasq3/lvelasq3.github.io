...
<div style="display: grid; grid-template-columns: 1fr 2fr; gap: 2rem; align-items: center; margin: 2.5rem 0 4rem 0;">
  ...
  <div>
    ...
    <p>The Tendon-Actuated Modular Prosthesis (TAMP) is a configurable research platform developed to investigate biologically informed prosthetic design, sensory feedback, control, and evaluation.</p>

    <p><a href="/talks/" class="btn btn--primary">View More Videos</a></p>
  </div>
...
<div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 2rem; align-items: start; margin-top: 2rem;">
